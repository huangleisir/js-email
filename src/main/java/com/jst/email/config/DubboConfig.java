...
public class DubboConfig {
    ...
    public static AnnotationBean annotationBean() {
        ...
        annotationBean.setPackage("com.jst.email.dubbo.service,com.jst.prodution.email,com.jst.email.service,com.jst.email.controller");
